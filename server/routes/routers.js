...
// change Profile Info
router.post(
  "/api/user/editProfile/changeInfo",
  userController.change_Profile_Info
);
// Change Password
router.post(
  "/api/user/editProfile/changePassword",
  userController.changePassword
);

// UPLOAD NEW Profile Picture
router.post(
  "/api/user/editProfile/uploadAvatar",
  userController.upload_Profile_Picture
);
//Change Profile Picture
router.post(
  "/api/user/editProfile/changeAvatar",
  userController.Change_Profile_Picture
);
//remove photo
router.post(
  "/api/user/editProfile/removePicture",
  userController.Remove_photo_from_Gallery
);
...
router.post(
  "/api/rooms/chat/active-chat",
  chatRoomController.get_chatRoomByRoomId
);

// get all chatRooms for a user
router.post(
  "/api/:userid/all-rooms/join",
  chatRoomController.getAllChatRoomsByUserId
);

// create a new message
router.post(
  "/api/messages/newMessage/create",
...
router.post(
  "/api/messages/chatRoom/mark-read",
  messageController.mark_AllRoomMessages_AsRead_ByUser
);
...
router.post("/api/calls//user/mycalls", callController.getCalls_By_UserId);
